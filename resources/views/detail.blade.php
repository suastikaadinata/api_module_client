...
<div>
	...
	<div class="add-container">
		<form action="update/{{ $inventory['id'] }}" enctype="multipart/form-data" method="post">
			{{ csrf_field() }}
			<div class="row">
					...
					<div class="row">
						<div class="col-sm-3 col-3">
							<div class="img-preview">
								<img id="img-pv-1" src="{{ $inventory['foto'] }}" alt="Foto Inventaris">
							</div>
				...
				<div class="col-lg-4 col-md-4 col-4">
					<div class="input-group mb-3">
						<input type="text" class="form-control" aria-label="Nama Produk" aria-describedby="basic-addon1"
							name="nama" value="{{ $inventory['nama'] }}" required>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-4">
					<div class="input-group mb-3">
						<input type="date" class="form-control" aria-label="Nama Produk" aria-describedby="basic-addon1"
							name="tanggal" value="{{ $inventory['tgl_pembelian'] }}" required>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-4">
					<div class="input-group mb-3">
						<input type="number" class="form-control" aria-label="Nama Produk"
							aria-describedby="basic-addon1" name="harga" value="{{ $inventory['harga'] }}" required>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-4">
					<div class="input-group mb-3">
						<input type="text" class="form-control" aria-label="Nama Produk" aria-describedby="basic-addon1"
							name="no_bukti" value="{{ $inventory['no_bukti'] }}" required>
					</div>
				</div>
			</div>
